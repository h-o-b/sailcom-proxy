...
public class WeatherSvc {
	...
	public static List<WeatherInfo> getWeatherInfo(ServerSession session, int harborId, boolean isDet) throws IOException, ParseException {
		...
		Harbor h = session.getHarbor(harborId);
